        ...
        <section className="grid flex-1 items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/checkin"
                className="rounded-xl bg-indigo-600 px-6 py-3 text-center font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-indigo-700 hover:shadow-md"
              >
                開始今日 Check-in
              </Link>
              ...
              <Link
                to="/history"
                className="rounded-xl border border-slate-300 bg-white px-6 py-3 text-center font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-indigo-200 hover:bg-slate-100"
              >
                查看狀態趨勢
              </Link>
            </div>
